      ...
      *                  FOR ERROR MESSAGING                                    
       01  MODNAME                      PIC  X(08) VALUE 'GVBXR8  '.            
      ...
      *                      LENGTH OF STORAGE AREA                             
       ...
       01  WS-WORKAREA-SIZE             PIC S9(08) COMP.                        
      ...
      *****************************************************************         
       01  GVBTP90-RECORD-KEY           PIC X(10).                              
      *                                                                         
      ...
      *                                                                         
       01  FILLER                       PIC X(40)       VALUE                   
           'WORKING STORAGE FOR GVBXR8 ENDS HERE'.                              
      ...
      *****************************************************************         
       ...
       000-MAIN-LOGIC.                                                          
           ...
           DISPLAY 'GVBXR8: WS-FNCL-EOF-SW          = '                         
                      WS-FNCL-EOF-SW                                            
           DISPLAY 'GVBXR8: X95PARM1-PHASE-CODE     = '                         
                      X95PARM1-PHASE-CODE                                       
           DISPLAY 'GVBXR8: X95PARM1-PARTITION-COUNT= '                         
                      X95PARM1-PARTITION-COUNT                                  
           DISPLAY 'GVBXR8: X95PARM2-EVENT-DDNAME   = '                         
                      X95PARM2-EVENT-DDNAME                                     
           DISPLAY 'GVBXR8: WS-FIRST-TIME-SW        = '                         
                      WS-FIRST-TIME-SW                                          
      *OPEN PHASE                                                               
           IF   X95PARM1-OPEN-PHASE                                             
             DISPLAY 'GVBXR8: OPEN PHASE'                                       
             DISPLAY 'GVBXR8: THREAD-NBR = ' X95PARM1-THREAD-NBR                
             DISPLAY 'GVBXR8: CURRENT-VIEW-ID = '                               
                      X95PARM1-CURRENT-VIEW-ID                                  
             DISPLAY 'GVBXR8: PROCESS DATE AND TIME: '                          
      ...
      *FIRST TIME READ                                                          
           IF WS-FIRST-TIME                                                     
             DISPLAY 'GVBXR8: FIRST TIME'                                       
             PERFORM 100-INIT               THRU 100-EXIT                       
           ELSE                                                                 
             IF WS-TRACE-TIME-SW = 1                                            
               DISPLAY 'GVBXR8: SUBSEQUENT' X95PARM1-CURRENT-VIEW-ID            
             ELSE                                                               
               DISPLAY 'GVBXR8:'                                                
             END-IF                                                             
           END-IF                                                               
      ...
      *  UNLOAD LB952/LB949/EANNY RECORDS TO GENEVA                             
           DISPLAY 'GVBXR8: FIRST 600-UNLD-FNCL-BLK-TBL '                       
      ...
      *  TRANSLATION/ADVANCE RECORD CREATION/PEND CREATION                      
           DISPLAY 'GVBXR8: 200-FNCL-RCRD-CNTL ===>>> '                         
                   'WS-TB-ROWS-REMAINING = ' WS-TB-ROWS-REMAINING               
      *                                                                         
      ...
      *                                                                         
      *  UNLOAD LB952/LB949/EANNY RECORDS TO GENEVA                             
           DISPLAY 'GVBXR8: SECOND 600-UNLD-FNCL-BLK-TBL'                       
                   ' WS-TB-ROWS-REMAINING = ' WS-TB-ROWS-REMAINING              
           PERFORM 600-UNLD-FNCL-BLK-TBL                                        
                   UNTIL  WS-TB-ROWS-REMAINING NOT GREATER +0                   
      ...
      *                                                                         
           DISPLAY 'GVBXR8: X95PARM2-EVENT-REC-LEN  = '                         
                      X95PARM2-EVENT-REC-LEN                                    
           DISPLAY 'GVBXR8: X95PARM2-MAC-REC-LEN    = '                         
                      X95PARM2-MAX-REC-LEN                                      
           DISPLAY 'GVBXR8: X95PARM2-MAX-BLOCK-SIZE = '                         
      ...
      *                                                                         
           ...
           SET X95PARM7-WORK-AREA-ANCHOR                                        
                                      TO WS-TP90-INPT-PTR                       
      *                                                                         
           DISPLAY 'GVBXR8: ' WS-WORK-AREA-LNGTH                                
      ...
      *   START VSAM BROWSE                                                     
      *                                                                         
           MOVE  '0000000001'                TO GVBTP90-RECORD-KEY              
           MOVE GVBTP90-VALUE-START-BROWSE   TO GVBTP90-FUNCTION-CODE           
                                                                                
           PERFORM 0900-LB949-INPT-FILE                                         
      *                                                                         
           DISPLAY 'GVBXR8: VSAM BROWSE STARTED AT: ' GVBTP90-RECORD-KEY        
      *                                                                         
      ...
      *                                                                         
             ...
             IF WS-TOKEN-RTRN-CD NOT = ZERO                                     
                 DISPLAY ' '                                                    
                 DISPLAY                                                        
                   'GVBXR8: UNABLE TO CREATE NAME/TOKEN, RC: '                  
                                     WS-TOKEN-RTRN-CD                           
                 STOP 666                                                       
             ELSE                                                               
                 ...
                 MOVE X95PARM1-PARTITION-COUNT TO                               
                      LS-PARTITIONS-TOTAL                                       
      *                                                                         
                 DISPLAY 'GVBXR8: GLOBAL WORKAREA ALLOCATED BY THREAD '         
                         X95PARM1-THREAD-NBR                                    
                 DISPLAY 'GVBXR8: TOTAL PARTITIONS PRESENT '                    
                        LS-PARTITIONS-TOTAL                                     
             END-IF                                                             
           ELSE                                                                 
             SET ADDRESS OF LS-GLOBAL-WORKAREA                                  
      ...
      *                                                                         
                 DISPLAY 'GVBXR8: END OF FILE REACHED -----------------'        
      ...
      *                                                                         
             WHEN OTHER                                                         
                 ...
                 DISPLAY 'GVBXR8: '                                             
                     X95PARM2-EVENT-DDNAME '  '                                 
                  GVBTP90-DDNAME                                                
                  '  GVBXR8-0200, GVBTP90 READ INPUT FAILED'                    
      ...
      * **************     FULL BLOCK        ******************                 
           ...
           IF WS-TB-ROWS-REMAINING GREATER WS-TB-ROWS-PER-BUFFER                
              ...
              DISPLAY 'GVBXR8: RETURNING FULL BLOCK'                            
      *                                                                         
      * **************     PARTIAL BLOCK     ******************                 
           ELSE                                                                 
      *                                                                         
              ...
              MOVE +0                     TO WS-TB-ROWS-REMAINING               
                                                WS-TB-INCREMENT                 
              MOVE +1                     TO WS-TB-STRT-ENTRY                   
              DISPLAY 'GVBXR8: RETURNING PART BLOCK'                            
           END-IF                                                               
