//NCBDEMF1 JOB (ACCT),'SAFR FORMAT PHASE   ',                                   
//          NOTIFY=&SYSUID.,                                                    
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
//          MSGCLASS=X                                                          
...
//SYSIN    DD *,SYMBOLS=EXECSYS                                                 
 ...
 DELETE  &HLQ..&MLQ..PASS1F0.F0010720.SET1   PURGE                              
...
//            DISP=SHR                                                          
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..PASS1E1.FILE000.SXT,                              
//            DISP=SHR                                                          
//*                                                                             
//SORTCNTL DD *                                                                 
 OPTION DYNALLOC=(SYSDA,5),MAINSIZE=32M,RESALL=1M,VLSHRT                        
//*                                                                             
//SORTIN   DD DSN=&HLQ..&MLQ..PASS1E1.FILE000.EXT,                              
//            DISP=SHR                                                          
//*                                                                             
//MR88HXE  DD DUMMY                                                             
//*                                                                             
...
//*        <<< OUTPUT VIEW FILES >>>                                            
//*                                                                 %%%         
//F0010720 DD DSN=&HLQ..&MLQ..PASS1F0.F0010720.SET1,                            
...
//*                                                                             
//*********************************************************************         
//* PSTEP206 - DELETE THE FILE(S) CREATED IN NEXT STEP                          
//*                                                                             
//* NORMAL RETURN CODE = 0                                                      
//*                                                                             
//* IF THIS STEP ABENDS:                                                        
...
//SYSIN    DD *,SYMBOLS=EXECSYS                                                 
 ...
 DELETE  &HLQ..&MLQ..PASS1F0.F0010720.SET2   PURGE                              
...
//*                                                                             
//*********************************************************************         
//* PSTEP207 - SUMMARIZE AND FORMAT VIEWS                                       
//*                                                                             
//* NORMAL RETURN CODES:                                                        
//*                                                                             
//*    0 = SUCCESSFUL, MARGINAL (HXM) FILE LOADED                               
...
//*        <<< OUTPUT VIEW FILES >>>                                            
//*                                                                 %%%         
//F0010720 DD DSN=&HLQ..&MLQ..PASS1F0.F0010720.SET2,                            
//            DISP=(NEW,CATLG,DELETE),                                          
//            UNIT=SYSDA,                                                       
//            SPACE=(TRK,(10,10),RLSE),                                         
//            DCB=(DSORG=PS,RECFM=FB,LRECL=131)                                 
