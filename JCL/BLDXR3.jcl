//NBLDXR3  JOB (ACCT),'GENEVAERS BUILD ASM',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                       
//*********************************************************************         
//*  ASSEMBLE AND LINK GVBXR3 READ EXIT                   
//*********************************************************************         
//*                                                                             
//         EXPORT SYMLIST=*                                                     
//*                                                                             
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.ASM(GVBXR3),                                
//            DISP=SHR                                                          
//*                                                                             
...
//*                                                                             
//**********************************************************************        
//*  LINK-EDIT GVBXR3          APF AUthorized                                                 
//**********************************************************************        
//*                                                                             
//GVBXR3   EXEC PGM=IEWL,                                                       
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBXR3),                            
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
