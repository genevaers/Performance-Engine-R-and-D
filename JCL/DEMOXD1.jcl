//NCBDEMD1 JOB (ACCT),'GENEVAERS DEMO PASS1',                                   
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                 %%%         
//DDUSER   DD DISP=SHR,DSN=GEBT.RTC22964.USERS                                  
//*                                                                             
...
//SYSIN    DD *,SYMBOLS=EXECSYS                                                 
 ...
 DELETE  &HLQ..&MLQ..PASS1E1.FILE000.EXT PURGE                                  
 DELETE  &HLQ..&MLQ..PASS1E1.FILE000.SXT PURGE                                  
...
//*        <<< INPUT SOURCE FILES >>>                                           
//*                                                                 %%%         
//*           THIS IS READ EXIT GVBXR1                                          
//*                                                                             
//*        <<< OUTPUT FILES GOING TO FORMAT PHASE >>>                           
//*                                                                             
//EXTR000  DD DSN=&HLQ..&MLQ..PASS1E1.FILE000.EXT,                              
//            DISP=(NEW,CATLG,DELETE),                                          
//            UNIT=(SYSDA,10),                                                  
//            SPACE=(TRK,(1,1000),RLSE),                                        
//            DCB=(DSORG=PS,RECFM=VB,LRECL=8192)                                
//*                                                                             
//SORT000  DD DSN=&HLQ..&MLQ..PASS1E1.FILE000.SXT,                              
//            DISP=(NEW,CATLG,DELETE),                                          
//            UNIT=SYSDA,                                                       
//            SPACE=(TRK,(1,1),RLSE),                                           
...
//SYSIN    DD DUMMY                                                             
//*                                                                             
//SYSUT1   DD DSN=&HLQ..&MLQ..JCL(DEMOXF1),                            
//            DISP=SHR                                                          
//*                                                                             
