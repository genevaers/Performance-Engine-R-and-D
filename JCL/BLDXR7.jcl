//BLDXR7   JOB (ACCT),'GENEVAERS BUILD ASM',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                             
//****************************************************************              
//*  ASSEMBLE GVBXR7 which used GVBTP0 FOR QSAM ACCESS
//****************************************************************              
//*                                                                             
//ASM      EXEC PGM=ASMA90,                                                     
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.ASM(GVBXR7),                                
//            DISP=SHR                                                          
//*                                                                             
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBXR7),                            
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
