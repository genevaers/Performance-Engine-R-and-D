//NCBDEMF3 JOB (ACCT),'SAFR FORMAT PHASE   ',                                   
//          NOTIFY=&SYSUID.,                                                    
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
//          MSGCLASS=X                                                          
...
//SYSIN    DD *,SYMBOLS=EXECSYS                                                 
 ...
 DELETE  &HLQ..&MLQ..PASS1F0.F0010722.SET4   PURGE                              
...
//            DISP=SHR                                                          
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..PASS1E1.FILE004.SXT,                              
//            DISP=SHR                                                          
//*                                                                             
//SORTCNTL DD *                                                                 
 OPTION DYNALLOC=(SYSDA,5),MAINSIZE=32M,RESALL=1M,VLSHRT                        
//*                                                                             
//SORTIN   DD DSN=&HLQ..&MLQ..PASS1E1.FILE004.EXT,                              
//            DISP=SHR                                                          
//*                                                                             
//MR88HXE  DD DUMMY                                                             
//*                                                                             
...
//*        <<< OUTPUT VIEW FILES >>>                                            
//*                                                                 %%%         
//F0010722 DD DSN=&HLQ..&MLQ..PASS1F0.F0010722.SET4,                            
