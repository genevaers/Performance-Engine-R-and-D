//NCBDEMD3 JOB (ACCT),'GENEVAERS DEMO PASS3',                                   
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//SYSIN    DD *,SYMBOLS=EXECSYS                                                 
 ...
 DELETE  &HLQ..&MLQ..PASS1E1.FILE004.EXT PURGE                                  
 DELETE  &HLQ..&MLQ..PASS1E1.FILE004.SXT PURGE                                  
...
//*        <<< INPUT SOURCE FILES >>>                                           
//*                                                                 %%%         
//*           THESE ARE READ BY GVBXR5                                          
//*                                                                 %%%         
//DDDSNAME DD DISP=SHR,DSN=GEBT.RTC22589.PASS1F0.F0010720.SET2                  
//DDGROUP  DD DISP=SHR,DSN=GEBT.RTC22589.PASS1F0.F0010721.SET3                  
//*                                                                             
//*        <<< OUTPUT FILES GOING TO FORMAT PHASE >>>                           
//*                                                                             
//EXTR004  DD DSN=&HLQ..&MLQ..PASS1E1.FILE004.EXT,                              
//            DISP=(NEW,CATLG,DELETE),                                          
//            UNIT=(SYSDA,10),                                                  
//            SPACE=(TRK,(1,1000),RLSE),                                        
//            DCB=(DSORG=PS,RECFM=VB,LRECL=8192)                                
//*                                                                             
//SORT004  DD DSN=&HLQ..&MLQ..PASS1E1.FILE004.SXT,                              
//            DISP=(NEW,CATLG,DELETE),                                          
//            UNIT=SYSDA,                                                       
//            SPACE=(TRK,(1,1),RLSE),                                           
...
//SYSIN    DD DUMMY                                                             
//*                                                                             
//SYSUT1   DD DSN=&HLQ..&MLQ..JCL(DEMOXF3),                                     
//            DISP=SHR                                                          
//*                                                                             
