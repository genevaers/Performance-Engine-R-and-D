//BLDXR6   JOB (ACCT),'GENEVAERS BUILD COB',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                             
//*********************************************************************         
//*   COMPILE AND LINK COBOL READ EXIT USING GVBTP90 QSAM ACCESS                
//*********************************************************************         
//*                                                                             
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.COBOL(GVBXR6),DISP=SHR                      
//*                                                                             
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBXR6),                            
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
