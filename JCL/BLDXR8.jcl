//BLDXR8   JOB (ACCT),'GENEVAERS BUILD COB',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*     
//*********************************************************************         
//*   COMPILE AND LINK GVBXR8 READ EXIT USING GVBTP90 VSAM ACCESS                
//*********************************************************************         
//*                                                                             
//         EXPORT SYMLIST=*                                                     
//*                                                                             
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.COBOL(GVBXR8),DISP=SHR                      
//*                                                                             
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBXR8),                            
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
