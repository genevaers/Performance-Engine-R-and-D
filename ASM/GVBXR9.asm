        TITLE 'GVBXR9 - READ EXIT - VSAM I/O TP90'                              
**********************************************************************          
*                                                                               
...
*                           ENVIRONMENT.                              *         
*                                                                     *         
*                         : THIS MODULE WILL READ RECORDS VIA VSAM    *         
*                                                                     *         
...
*            - RETURN    ADDRESS                                      *         
*                                                                     *         
*        R13 - REGISTER  SAVE AREA    ADDRESS (GVBXR9  WORK AREA)     *         
*                                                                     *         
...
*                                                                               
         MVC   0(l'GVBXR9EY,R1),GVBXR9EY                                        
         aghi  r1,l'GVBXR9EY        move pointer past                           
         drop  r13                                                              
         USING XRCKWORK,R1                                                      
...
*                                                                               
         ...
         JNE   A0200                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(18),=CL18'GVBXR9: OPEN PHASE'                            
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
         BRAS  R10,LOADB                                                        
...
A0200    EQU   *                                                                
         ...
         JNE   A0300                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(19),=CL19'GVBXR9: CLOSE PHASE'                           
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
         J     RETURNX                                                          
...
A0300    EQU   *                                                                
         ...
         JNE   A0400                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(18),=CL18'GVBXR9: READ PHASE'                            
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
         BRAS  R10,LOADB                                                        
...
A0400    EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(29),=CL29'GVBXR9: UNRECOGNIZED PHASE XX'                 
...
*                                                                               
***********************************************************************         
*   FILL   NEXT "BUFSIZE" buffer by browsing through VSAM file        *         
***********************************************************************         
LOADB    DS    0H                                                               
         CLI   WKEOF,C'Y'                                                       
         JNE   LOADB10                                                          
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(57),=CL57'GVBXR9: ALREADY AT END OF FILE. RETURN+        
               ING RC=8 TO GVBMR95'                                             
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(35),=CL35'GVBXR9: BLOCKS RETURNED TO GVBMR95 '           
         L     R15,WKBUFRET                                                     
         CVD   R15,WKDBLWK                                                      
...
*                                                                               
LOADB10  EQU   *                                                                
         MVC   PAFUNC,=CL2'BR'    INITIALIZE FUNCTION CODE                      
...
*                                                                               
         IF (LTR,R15,R15,NZ)                                                    
           ...
           IF (CLC,PARTNC,EQ,=C'2')                                             
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(20),=CL20'GVBXR9: END OF FILE.'                      
             LA    R2,OUTDCB                                                    
             LA    R0,WKPRINT                                                   
             PUT   (R2),(R0)                                                    
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(39),=CL39'GVBXR9: Records read in this parti+        
               tion:'                                                           
             L     R15,WKRECCNT                                                 
             CVD   R15,WKDBLWK                                                  
...
*                                                                               
             IF (CLC,GLOPARTP,GE,GLOPARTT)                                      
               MVC   WKPRINT,SPACES                                             
               MVC   WKPRINT(39),=CL39'GVBXR9: Records read in all part+        
               itions:'                                                         
               L     R15,GLOREC#                                                
               CVD   R15,WKDBLWK                                                
               MVC   WKPRINT+40(7),NUMMSK+5                                     
               ...
               PUT   (R2),(R0)                                                  
               MVC   WKPRINT,SPACES                                             
               MVC   WKPRINT(39),=CL39'GVBXR9: Number of partitions pro+        
               cessed:'                                                         
               L     R15,GLOPARTP                                               
               CVD   R15,WKDBLWK                                                
               MVC   WKPRINT+40(7),NUMMSK+5                                     
...
*                                                                               
           ELSE                                                                 
             MVC   WKPRINT(30),=CL30'GVBXR9: Read Error xxxx/xxxx X'            
...
*                                                                               
           IF (CLI,WKTRACE,GE,C'2')                                             
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(20),=CL20'GVBXR9: RECORD READ '                      
             L     R1,TP90RECA                                                  
...
*      echo DDNAME                                                              
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(32),=CL32'GVBXR9: Being executed with DD:'               
...
*      echo THRD#                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(34),=CL34'GVBXR9: Being executed in thread:'             
         LH    R15,WKTHRDNO                                                     
         CVD   R15,WKDBLWK                                                      
...
*      echo NUMBER PARTITIONS                                                   
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(32),=CL32'GVBXR9: Total number partitions:'              
         L     R15,WKPARTS#                                                     
         CVD   R15,WKDBLWK                                                      
...
*      echo VIEW#                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(34),=CL34'GVBXR9: Being executed with VIEW:'             
         L     R15,WKVIEW#                                                      
         CVD   R15,WKDBLWK                                                      
...
*      echo GPLFID                                                              
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(34),=CL34'GVBXR9: Being executed with LFID:'             
         L     R15,WKGPLFID                                                     
         CVD   R15,WKDBLWK                                                      
         MVC   WKPRINT+34(7),NUMMSK+5                                           
         MVI   WKPRINT+34,C' '                                                  
...
*      echo MR95ENVV                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(38),=CL38'GVBXR9: Being executed with MR95ENVV:'         
...
*      echo DATETIME                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(33),=CL33'GVBXR9: Being executed DateTime:'              
...
*      echo GP_STARTUP_DATA                                                     
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(37),=CL37'GVBXR9: Being executed with startup:'          
...
*                                                                               
         IF (LTR,R15,R15,NZ)                                                    
           MVC   WKPRINT,SPACES                                                 
           MVC   WKPRINT(30),=CL30'GVBXR9: Open Error xxxx/xxxx X'              
           MVC   WKPRINT+29(1),PARTNC                                           
           XGR   R15,R15                                                        
           ICM   R15,B'0001',PAVSAMRC+1                                         
           CVD   R15,WKDBLWK                                                    
         ...
         ELSE                                                                   
           MVC   WKPRINT,SPACES                                                 
           MVC   WKPRINT(26),=CL26'GVBXR9: INPUT FILE OPENED: '                 
...
***********************************************************************         
*                                                                               
         MVC   PAFUNC,=CL2'SB'    INITIALIZE FUNCTION CODE                      
         MVC   PADDNAME,WKDDNAME     '       DDNAME                             
         MVI   PAFTYPE,C'V'       FILE TYPE                                     
         MVC   PAFMODE,=CL2'I '   FILE MODE                                     
         MVI   PARECFMT,C'F'      FORMAT                                        
*                                                                               
*     START BROWSE FROM KEY VALUE                                               
         MVC   WKKEY(10),=CL10'0000000001'                                      
*                                                                               
         LA    R1,TP90LIST        POINT R1 TO PARAMETER LIST                    
*        L     R15,=V(GVBTP90)    LOAD  ADDRESS OF "GVBTP90"                    
         L     R15,GVBTP90        LOAD  ADDRESS OF "GVBTP90"                    
...
*                                                                               
         IF (LTR,R15,R15,NZ)                                                    
           ...
           IF (CLC,PARTNC,EQ,=C'2')                                             
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(35),=CL35'GVBXR9: END OF FILE AT START BROWS+        
                E'                                                              
             LA    R2,OUTDCB                                                    
             LA    R0,WKPRINT                                                   
             PUT   (R2),(R0)                                                    
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(21),=CL21'GVBXR9: Records read '                     
             L     R15,WKRECCNT                                                 
             CVD   R15,WKDBLWK                                                  
             MVC   WKPRINT+21(7),NUMMSK+5                                       
             MVI   WKPRINT+21,C' '                                              
             ED    WKPRINT+21(7),WKDBLWK+5                                      
             LA    R2,OUTDCB                                                    
             LA    R0,WKPRINT                                                   
             PUT   (R2),(R0)                                                    
*                                                                               
           ...
           ELSE                                                                 
             MVC   WKPRINT,SPACES                                               
             MVC   WKPRINT(38),=CL38'GVBXR9: Start Browse Error xxxx/xx+        
                xx X'                                                           
             MVC   WKPRINT+35(1),PARTNC                                         
             XGR   R15,R15                                                      
             ICM   R15,B'0001',PAVSAMRC+1                                       
             CVD   R15,WKDBLWK                                                  
             ...
             ICM   R15,B'0001',PAVSAMRC                                         
             CVD   R15,WKDBLWK                                                  
             MVC   WKPRINT+32(4),NUMMSK+8                                       
             MVI   WKPRINT+32,C' '                                              
             ED    WKPRINT+32(4),WKDBLWK+6                                      
             LA    R2,OUTDCB                                                    
             LA    R0,WKPRINT                                                   
             PUT   (R2),(R0)                                                    
*                                                                               
         ...
         ELSE                                                                   
           MVC   WKPRINT,SPACES                                                 
           MVC   WKPRINT(31),=CL31'GVBXR9: Browse started at key: '             
           L     R1,TP90RECA                                                    
           MVC   WKPRINT+31(10),WKKEY                                           
           LA    R2,OUTDCB                                                      
           LA    R0,WKPRINT                                                     
           PUT   (R2),(R0)                                                      
         ENDIF                                                                  
...
INITENQ  MVC   REENTWK(MDLENQXL),MDLENQX                                        
         ...
         LTR   R15,R15                                                          
         JZ    INITGLOB                                                         
         WTO 'GVBXR9: GLOBAL AREA ENQ FAILED'                                   
         MVC   WKRETC,=F'16'                                                    
         J     I0099                                                            
*                                                                               
***********************************************************************         
...
***********************************************************************         
         ...
         LTGF  R15,WKTOKNRC       SUCCESSFUL  ???                               
         JZ    INITDEQ                                                          
         WTO 'GVBXR9: GLOBAL AREA CREATE FAILED'                                
         MVC   WKRETC,=F'16'                                                    
***********************************************************************         
