...
*            - RETURN    ADDRESS                                      *         
*                                                                     *         
*        R13 - REGISTER  SAVE AREA    ADDRESS (GVBXR3  WORK AREA)     *         
*                                                                     *         
...
DYNACT   DS    XL(ACTLEN)                DYNAMIC ICHEACTN AREA                  
         DS    0F                                                               
DYNACT1  DS    XL(ACTLEN1)               DYNAMIC ICHEACTN AREA                  
         DS    0F                                                               
...
RETACLCL DS    F                         RETURNED ACLCNT     LENGTH             
RETACLCT DS    F                         RETURNED ACLCNT                        
...
*                                                                               
         MVC   0(l'GVBXR3EY,R1),GVBXR3EY                                        
         aghi  r1,l'GVBXR3EY        move pointer past                           
         drop  r13                                                              
         USING DYNAREA,R1                                                       
...
*                                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(20),=CL20'GVBXR3: PHASE IS: XX'                          
...
A0000    EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(37),=CL37'GVBXR3: NORMAL ENTRY, NO RESUME POINT'         
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
*                                                                               
...
A0400    EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(29),=CL29'GVBXR3: UNRECOGNIZED PHASE XX'                 
...
LOADB    DS    0H                                                               
         ...
         JNE   LOADB02                                                          
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(57),=CL57'GVBXR3: ALREADY AT END OF FILE. RETURN+        
               ING RC=8 TO GVBMR95'                                             
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
*                                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(35),=CL35'GVBXR3: BLOCKS RETURNED TO GVBMR95 '           
         L     R15,WKBUFRET                                                     
         CVD   R15,WKDBLWK                                                      
...
LOADB02  EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(26),=CL26'GVBXR3: LOADING I/O BUFFER'                    
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
*                                                                               
*        LOOP TO RETRIEVE ALL GROUP PROFILES                                    
...
A0010    EQU   *                                                                
         ...
         BCTR  R15,0                                                            
         EX    R15,MVCR14R1                                                     
         MVC   WKPRINT+8(8),WKGRP                                               
         MVC   WKPRINT+54(08),RETOWNER                                          
*                                                                               
         LR    R3,R13                                                           
         ICM   R6,B'1111',RETACLCT                                              
         JZ    A0016                                                            
A0012    EQU   *                                                                
...
*                                                                               
         ...
         MVC   RECRMEM,RETUSRID-DYNAREA(R3)                                     
...
*                                                                               
A0014    EQU   *                                                                
*        WTO 'GROUP MEMBER RETRIEVED'                                           
*                                                                               
         LA    R3,ACLLEN(,R3)                                                   
         BRCT  R6,A0012                  process next group member              
A0016    EQU   *                                                                
*                                                                               
*        WTO 'GROUP PROCESSED'                                                  
*                                                                               
...
A0088    EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(32),=CL32'GVBXR3: LOAD I/O BLOCK COMPLETED'              
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
...
A0090    EQU   *                                                                
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(20),=CL20'GVBXR3: END OF FILE.'                          
         LA    R2,OUTDCB                                                        
         LA    R0,WKPRINT                                                       
         PUT   (R2),(R0)                                                        
*                                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(41),=CL41'GVBXR3: Records returned in this extra+        
               ct '                                                             
         L     R15,WKRECCNT                                                     
         CVD   R15,WKDBLWK                                                      
...
*                                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(40),=CL40'GVBXR3: Groups processed in this extac+        
               t '                                                              
         L     R15,WKPRFCNT                                                     
         CVD   R15,WKDBLWK                                                      
         MVC   WKPRINT+41(7),NUMMSK+5                                           
...
*      echo DDNAME                                                              
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(32),=CL32'GVBXR3: Being executed with DD:'               
...
*      echo THRD#                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(33),=CL33'GVBXR3: Being executed in thread:'             
         LH    R15,WKTHRDNO                                                     
         CVD   R15,WKDBLWK                                                      
...
*      echo NUMBER PARTITIONS                                                   
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(32),=CL32'GVBXR3: Total number partitions:'              
         L     R15,WKPARTS#                                                     
         CVD   R15,WKDBLWK                                                      
...
*      echo VIEW#                                                               
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(33),=CL33'GVBXR3: Being executed with VIEW:'             
         L     R15,WKVIEW#                                                      
         CVD   R15,WKDBLWK                                                      
...
*      echo GPLFID                                                              
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(34),=CL34'GVBXR3: Being executed with LFID:'             
         L     R15,WKGPLFID                                                     
         CVD   R15,WKDBLWK                                                      
         MVC   WKPRINT+34(7),NUMMSK+5                                           
         MVI   WKPRINT+34,C' '                                                  
...
*      echo MR95ENVV                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(38),=CL38'GVBXR3: Being executed with MR95ENVV:'         
...
*      echo DATETIME                                                            
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(33),=CL33'GVBXR3: Being executed DateTime:'              
...
*      echo GP_STARTUP_DATA                                                     
         MVC   WKPRINT,SPACES                                                   
         MVC   WKPRINT(37),=CL37'GVBXR3: Being executed with startup:'          
...
STATACT1 ICHEACTN FIELD=ACLCNT                                                  
ACTLEN1  EQU   *-STATACT1                LENGTH OF ICHEACTN                     
STATACT2 ICHEACTN FIELD=ACL                                                     
ACTLEN2  EQU   *-STATACT2                LENGTH OF ICHEACTN                     
*                                                                               
STATICH  ICHEINTY NEXTC,TYPE='GRP',ENTRYX=*-*,RELEASE=1.9,DATAMAP=NEW, *        
               ACTIONS=(STATACT,STATACT1,STATACT2),WKAREA=*-*,MF=L              
