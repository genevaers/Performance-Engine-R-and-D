         TITLE 'GVBXLFIL - GET EVENT FILE INFORMATION'
**********************************************************************
*
...
*  MODULE DESCRIPTION:                                                *
*                                                                     *
*      - THIS MODULE RETURNS THE ADDRESS OF THE SAFR EVENT FILE       *
*        INFORMATION                                                  *
*                                                                     *
*                                                                     *
...
GVBXLFIL CSECT
         J     CODE
XLFIEYE  GVBEYE GVBXLFIL
*
CODE     STM   R14,R12,RSA14(R13) SAVE  CALLER'S  REGISTERS
*
         USING GENPARM,R1
*
         LLGT  R0,GPFILEA         LOAD ENV  INFO POINTER ADDRESS
